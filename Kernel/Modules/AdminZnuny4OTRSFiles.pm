...
# --
## nofilter(TidyAll::Plugin::OTRS::Znuny4OTRS::CodeStyle::GuardClause)
...
sub new {
    ...
    $Self->{CacheType} = 'Znuny4OTRSFiles';
...
sub Run {
    ...
    $LayoutObject->AddJSOnDocumentCompleteIfNotExists(
        Key  => 'AdminZnuny4OTRSFiles.InitTableFilter',
        Code => '
...
sub _ViewFile {
    ...
    my $Output = $LayoutObject->Output(
        TemplateFile => 'AdminZnuny4OTRSFiles/File',
        Data         => {
            File    => $FileDetails{Name},
            Content => ${$Content},
        },
...
sub _ShowFilesWidget {
    ...
    my $Output = $LayoutObject->Output(
        TemplateFile => 'AdminZnuny4OTRSFiles/Widget',
    );
...
Returns:
    ...
    my @Files = (
        {
            'StateMessage' => 'OK',
            'Path'         => 'Kernel/Config/Files/XML/Znuny4OTRSRepo.xml',
            'Type'         => 'Package',
            'Group'        => 'www-data',
            'User'         => 'staff',
            'Name'         => 'Znuny4OTRSRepo.xml',
            'Permissions'  => '0660',
            'State'        => 'OK',
            'Package'      => 'Znuny4OTRS-Repo',
            'FullPath'     => '/workspace/otrs/otrs_60New/Kernel/Config/Files/XML/Znuny4OTRSRepo.xml',
